...
<body>
  <main>
    <header>
      ...
      <p>
      <a href="{{ SITEURL }}/index.html"><i class="fab fas-archive"></i>HOME&nbsp;|&nbsp;</a>
      <a href="{{ SITEURL }}/pages/about.html"><i class="fab fas-archive"></i>About&nbsp;|&nbsp;</a>
      {% if ARCHIVES_URL %}
      ...
      {% endif %}
      {% block header %}
      <a href="{{ SITEURL }}/tags.html"><i class="fab fas-archive"></i>Tags&nbsp;|&nbsp;</a>
      <a href="{{ SITEURL }}/categories.html"><i class="fab fas-archive"></i>Categories</a>
      {% endblock header %}
      </p>
    </header>
